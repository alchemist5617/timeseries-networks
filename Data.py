...
class Data:
    ...
    def __init__(self,file_name, variable_name, temporal_limits=None, 
                 spatial_limits=None, missing_value = -9.969209968386869e+36):
        #Set file name
        ...
        data, index2d, lon_list, lat_list = self._unflatten_refine(data)           
        
        f.close()
        self._data = data
        self._index2d = index2d
        self._lon_list = lon_list
        self._lat_list = lat_list
